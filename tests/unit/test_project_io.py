...
def test_schema_seven_package_load_versions_semantic_contract_without_state_drift(
    tmp_path: Path,
) -> None:
    project = PlannerProject(title="Safe schema seven", subject_id="mouse-v7")
    package = save_project(project, tmp_path / "schema-seven")
